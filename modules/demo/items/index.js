    ...
    constructor() {
        ...
        this.content.row().group({
            ...
            content:$(`
                ...
                <fieldset>
                    <label><input type="radio" name="item_radio"> Radio1</label>
                    <label><input type="radio" name="item_radio"> Radio2</label>
                    <label><input type="radio" name="item_radio"> Radio3</label>
                </fieldset>
                <label>Select: 
